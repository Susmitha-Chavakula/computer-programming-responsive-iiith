window.view = {
	...
	validateRightAngleTriangleInputs: function() {
		...
		if ( a !== '1')
			alert('Incorrect value of input variables(arguments). Calculating the area of an isosceles right angled triangle requires the length of a side of which height and base are equal for an isosceles right angled triangle. Try again.')
		else if ( b !== 'float' )
			alert('Incorrect datatype of input variables(arguments). The value of the sides of a isosceles right angled triangle need not be integers. Try again.')
		else if ( c !== 'float' )
			alert('Incorrect datatype for return type. The value of the area of a isosceles right angled triangle need not be an integer. Try again.')
		else if ( d !== '(a*a)/2' )
			alert('Incorrect formula for calculating the area of a isosceles right angled triangle. Try again.')
		else
	...
	displayFunctionForRightAngleTriangle: function() {
		document.getElementById('functionRightAngleTriangle').innerHTML += 'float area_rightangletriangle (float a)<br>{<br> &emsp; float area = (a*a)/2;<br> &emsp; return area;<br>}'
	},
	...
	calculateArea: function() {
		...
		for ( i = 0 ; i < elements.length ; i ++ ) {
			...
			if ( parameter.length === 1 ) {
				...
				else if ( functionCall === 'area_rightangletriangle()' && isNaN(parameter) === false )
